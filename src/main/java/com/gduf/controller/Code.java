...
//    pk题目数量
    public static final Integer BRONZE_QUESTION_NUM = 3;
    public static final Integer SILVER_QUESTION_NUM = 3;
    public static final Integer GOLD_QUESTION_NUM = 3;
    public static final Integer PLATINUM_QUESTION_NUM = 3;
    public static final Integer KING_QUESTION_NUM = 3;
